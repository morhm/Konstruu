...
class API {
    ...
    class func getUserWithId(_ id: String, completed: @escaping (DataStructures.User?) -> Void) {
        databaseReference.child("users").child(id).observeSingleEvent(of: .value, with: { snapshot in
            let userInfo = snapshot.value as? NSDictionary
            if let name = userInfo?["name"] as? String {
                completed(DataStructures.User(id: id, name: name))
            } else {
                completed(nil)
            }
        })
    ...
    class func getTeamsForUser(_ user: DataStructures.User, completed: @escaping ([DataStructures.Team?]?) -> Void) {
        // TODO
    }
    
    class func getSkillsForUser(_ user: DataStructures.User, completed: @escaping ([String]?) -> Void) {
        // TODO
    }
    
    class func getBadgesForUser(_ user: DataStructures.User, completed: @escaping ([String]?) -> Void) {
        // TODO
    }
    ...
    class func getTeamWithId(_ id: String, completed: @escaping (DataStructures.Team?) -> Void) {
    ...
    class func getUsersForTeam(_ team: DataStructures.Team, completed: @escaping ([DataStructures.User?]?) -> Void) {
        // TODO
    }
    
    class func getChallengeForTeam(_ team: DataStructures.Team, completed: @escaping (DataStructures.Team?) -> Void) {
        // TODO
    }
    ...
    class func getChallengeWithId(_ id: String, completed: @escaping (DataStructures.Challenge?) -> Void) {
    ...
    class func getTeamsForChallenge(_ challenge: DataStructures.Challenge, completed: @escaping ([DataStructures.Team?]?) -> Void) {
        // TODO
    }
